...
@NgModule({
    imports: [
        ...
        IonicModule.forRoot(HousePropertyTypePipe),
        IonicModule.forRoot(CommercialPropertyTypePipe),
        IonicModule.forRoot(LandTypePipe),
        IonicModule.forRoot(OtherPropertyTypePipe),
        ...
        IonicModule.forRoot(AccessPipe),
        IonicModule.forRoot(EnergyPerformancePipe),
